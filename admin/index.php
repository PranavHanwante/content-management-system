    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-red">
            ...
            <a href="categories.php">
                ...
                $subcriber_count=mysqli_num_rows($select_all_subcribers);
      ...
      function drawChart() {
        ...
        <?php
            ...
            $element_text=['All Posts','Active Posts','Draft Posts', 'Comments','Pending Comments','Users','Subcribers', 'Categories'];
            $element_count=[$posts_count,$posts_published_count, $posts_draft_count, $comments_counts,$unapproved_comment_count, $users_counts,$subcriber_count, $categories_counts];
